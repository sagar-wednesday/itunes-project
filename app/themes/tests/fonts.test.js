...
describe('fonts', () => {
  ...
  it('should have the correct font-weight', () => {
    expect(fonts.weights.light()).toEqual(expect.arrayContaining([expect.stringContaining('font-weight:400;')]));
    expect(fonts.weights.bold()).toEqual(expect.arrayContaining([expect.stringContaining('font-weight:600;')]));
    expect(fonts.weights.normal()).toEqual(expect.arrayContaining([expect.stringContaining('font-weight:500;')]));
  });
  it('should have the correct font-weight and font-size', () => {
    expect(fonts.style.heading()).toEqual(expect.arrayContaining([expect.stringContaining('font-weight:600;')]));
    expect(fonts.style.heading()).toEqual(expect.arrayContaining([expect.stringContaining('font-size:1.5rem;')]));
    expect(fonts.style.subheading()).toEqual(expect.arrayContaining([expect.stringContaining('font-weight:600;')]));
    ...
    expect(fonts.style.standard()).toEqual(expect.arrayContaining([expect.stringContaining('font-weight:500;')]));
    expect(fonts.style.subText()).toEqual(expect.arrayContaining([expect.stringContaining('font-size:0.875rem;')]));
    expect(fonts.style.subText()).toEqual(expect.arrayContaining([expect.stringContaining('font-weight:500;')]));
  });
});
